...
namespace Supernova.Particles2D
{
    public class Particle2D
    {
        ...
        internal void Draw(SpriteBatch spriteBatch, Vector2 posAddition)
        {
         spriteBatch.Draw(texture, position + posAddition, null, color * alpha, rotation, origin, scale, SpriteEffects.None, 0);
        }
