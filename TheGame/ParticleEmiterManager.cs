...
class ParticleEmitterManager
{
    ...
    {
        var pos = gemGameObject.Position;
        var effect = ParticleEffect2DFactory.Initialize(3000, 1000)
    ...
    public void CreateWaterEmiter(ActorGameObject playerGameObject)
    {
        ...
        var pos = playerGameObject.Position + new Vector2(0, (float)playerGameObject.Bounds.Height * 0.6f);
        var effect = ParticleEffect2DFactory.Initialize(3000, nLifeSpan)
                                                         .SetMaxParticleSpeed(2f)
    ...
    {
        var effect = ParticleEffect2DFactory.Initialize(3000, 500)
                                                         .SetMaxParticleSpeed(2f)
                                                         .SetEmitAmount(100)
    ...
    {
        var effect = ParticleEffect2DFactory.Initialize(60, 50000)
    ...
    public void Update(GameTime gameTime)
    {
        ...
        foreach (var emitterHolder in m_emitterList)
        {
    ...
    public void Draw(SpriteBatch spriteBatch, xTile.Dimensions.Rectangle viewPort)
    {
        ...
        {
            var position = emitterHolder.Position;
